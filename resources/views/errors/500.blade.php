@php
    $app_url = env('APP_URL');
    $web_title = env('APP_NAME');
    $cat = 'Visit our website here ...';
    $header_title = ucfirst('yayasan dompet kebaikan umat');
    $address = 'Komplek Bandung Indah Raya C-5 No.20, RT.004/RW001, Mekarjaya, Kec. Rancasari, Kota Bandung, Jawa Barat 40292';
@endphp
<!doctype html>
<html>
...
<head>
    ...
    <link rel="shortcut icon" href="{{ $app_url }}/assets/icon/favicon.ico">
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 z-10 relative">
            <a href="#"
                ...
                <span class="text-xs bg-blue-600 rounded-full text-white px-4 py-1.5 mr-3">New</span> <span
                    class="text-sm font-medium">{{ $cat }}</span>
